...
echo $curuser;
$sql1 = "SELECT * from authority where a_id=$curuser";
$result1 = $conn->query($sql1);
$row1 = mysqli_fetch_assoc($result1);
$curlocation = $row1["party"];
$sql2 = "SELECT * from grouptable_authority where party='$curlocation'";
$result2 = $conn->query($sql2);
$row2 = mysqli_fetch_assoc($result2);
$curgid = $row2["gid_a"];
$curgname= $row2["group_name_a"];
$sql3 = "SELECT count(*) as total from group_authority where gid=$curgid";
...
if(isset($_POST["submit"]))
{
	...
	$sql6 = "Insert into authority_chat(g_id,u_id,message) values($curgid,$curuser,'$curmessage')";
...
<div class="menu">
	...
	$sql4 = "SELECT * from authority_chat where g_id=$curgid";
	...
	if($result4){
      ...
      <div class="msg">
        ...
        <time>';echo $row4["TimeCreated"];echo'</time>
				...
				$sql5 = "SELECT * from authority where a_id=$row4[u_id]";
